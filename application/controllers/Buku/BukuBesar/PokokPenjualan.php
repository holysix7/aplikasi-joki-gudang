...
class PokokPenjualan extends CI_Controller
{
  ...
  public function index(){
    ...
    $jurnal     = $this->m_jurnal->get_data_buku_pokok_penjualan();
    $saldo_akhir  = 0;
    $dataJurnal = [];
    ...
    $this->load->view('Buku/BukuBesar/PokokPenjualan', compact('name', 'dataJurnal', 'saldo_kas', 'saldo_akhir'));
  }
