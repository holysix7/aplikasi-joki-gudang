        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Buku Besar Penjualan </h1>
    ...
    $(document).ready(function(){   
        ...
        $('#id_end_date').change(function(){
            ...
            if(start_date != null || end_date != null){
                ...
                $.get(baseUrl+"/buku-besar/ajax/"+start_date+"/"+end_date+"/"+3, function(data, status){
                    if(data != null){
...
<script type="text/javascript">
    function exportKedua(){
        $('#example').table2excel({
            filename: "Ramen AA Buku Besar Penjualan"
        });
    }
</script>
