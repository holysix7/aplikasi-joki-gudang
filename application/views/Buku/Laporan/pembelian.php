                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body text-center">
                          <h5 class="card-title font-weight-bold">Laporan Pembelian</h5>
    ...
    $(document).ready(function(){   
        ...
        $('#id_end_date').change(function(){
            ...
            if(start_date != null || end_date != null){
                ...
                $.get(baseUrl+"/laporan/ajax/"+start_date+"/"+end_date+"/"+"pembelian", function(data, status){
                    // console.log(data)
                    if(data != null){
                        if(data.data_pembelian.length > 0){
                            ...
                            arrData.map(function(element){
                                var dateFormatPHP = new Date(element.purchase_date)
                                ...
                                var newObject = "<tr>" +
                                    "<td>"+ numberPlusOne +"</td>" +
                                    "<td>"+ element.kode_pembelian +"</td>" +
                                    "<td>"+ fixedDate +"</td>" +
                                    "<td class='text-right'>"+ format_rp(element.total_price) +"</td>" +
                                "</tr>"
...
<script type="text/javascript">
    function exportKedua(){
        $('#example').table2excel({
            filename: "Ramen AA Laporan Pembelian"
        });
    }
</script>
