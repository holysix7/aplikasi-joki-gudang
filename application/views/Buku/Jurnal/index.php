                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-4" id="id_header">
                                </div>
                            </div>
                            <br>
    ...
    $(document).ready(function(){   
        ...
        $('#id_end_date').change(function(){
            ...
            if(start_date != null || end_date != null){
                ...
                $.get(baseUrl+"/buku-besar/ajax/"+start_date+"/"+end_date+"/"+"jurnal", function(data, status){
                    if(data != null){
                        if(data.data_jurnal.length > 0){
                            ...
                            var number = 1
                            var newArrayBody = []
                            var newArrayHeader = "<div class='row d-flex justify-content-center'><p class='font-weight-bold'>Jurnal Umum</p></div><div class='row justify-content-center'><p class='font-weight-bold'>Ramen AA</p></div><div class='row justify-content-center'><p class='font-weight-bold'>Periode "+ $('#id_start_date').val() + " - " + $('#id_end_date').val() +" </p></div>"
                            ...
                            $('#id_header').append(newArrayHeader);
